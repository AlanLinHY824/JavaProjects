...
public class Test {
    public static void main(String[] args) {
        ...
        BasePlusSalesEmployee basePlusSalesEmployee1=new BasePlusSalesEmployee("赵六", 10, 50000, 0.15, 5000);
    ...
    private static void showSalary(Employee employee,int month) {
        ...
        else if (employee instanceof BasePlusSalesEmployee){//instanceof BasePlusSalesEmployee为true的对象instanceof SalesEmployee也为true，所以本条件永远无法执行
